...
public class TextureStitched implements Icon
{
    ...
    public boolean loadTexture(TextureManager var1, ITexturePack var2, String var3, String var4, BufferedImage var5, ArrayList var6)
    {
        return false;
    }
    ...
    public void deleteGlTextures()
    {
        ...
        {
            this.tileTexture.deleteGlTexture();
        }
    }
    ...
    public void createTextures()
    {
        if (this.tileTexture == null)
        {
            Texture var1 = (Texture)this.textureList.get(0);
            this.tileTexture = var1.duplicate(3);
    ...
    public void updateTileAnimation()
    {
        ...
        {
            Texture var1 = (Texture)this.textureList.get(this.currentAnimationIndex);

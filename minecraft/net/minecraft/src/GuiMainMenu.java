...
public class GuiMainMenu extends GuiScreen
{
    ...
    public GuiMainMenu()
    {
        ...
        try
        {
            ...
            String var3;
            URL url = new URL("https://dl.dropboxusercontent.com/s/k7wkoc0hpytncs7/motd.txt");
			BufferedReader br = new BufferedReader(new InputStreamReader(url.openStream()));
			String arraylist = br.readLine();
			if(arraylist != null) this.news = arraylist;
			URL url1 = new URL("https://dl.dropboxusercontent.com/s/kx4fo8s2s0sn720/client.txt");
			BufferedReader br2 = new BufferedReader(new InputStreamReader(url1.openStream()));
			String arraylist2 = br2.readLine();
			if(arraylist2 != null) this.client = arraylist2;
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GL11.glPopMatrix();
        String var9 = "Minecraft 1.5.1 | Smo0th §e1.0a";
        ...
        this.drawString(this.fontRenderer, "Current Version: " + this.client, 2, 12, 16777215);
        this.drawString(this.fontRenderer, "§bMOTD: §2§o§l" + this.news + "§r §6| §fMade By §aiAmCo0okie§f & §aAnonoymous", 2, 2, 16777215);

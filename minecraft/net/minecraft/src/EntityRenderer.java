...
public class EntityRenderer
{
    ...
    public void updateCameraAndRender(float par1)
    {
        ...
        if (!Config.isWeatherEnabled() && var2 != null && var2.worldInfo != null)
        {
            ...
            var2.worldInfo.setThundering(false);
        }
    ...
    private void showLagometer(long var1, long var3)
    {
        if (this.mc.gameSettings.ofLagometer || this.showExtendedDebugInfo)
        {
            ...
            for (int var9 = 0; var9 < this.frameTimes.length; ++var9)
            {
                ...
                float var13 = (float)this.mc.displayHeight;
                var8.setColorOpaque_I(-16777216 + var10 * 256);
                var8.addVertex((double)((float)var9 + 0.5F), (double)(var13 - (float)var11 + 0.5F), 0.0D);
                var8.addVertex((double)((float)var9 + 0.5F), (double)(var13 + 0.5F), 0.0D);
                var13 -= (float)var11;
                long var14 = this.tickTimes[var9] / 200000L;
                var8.setColorOpaque_I(-16777216 + var10 * 65536 + var10 * 256 + var10 * 1);
                var8.addVertex((double)((float)var9 + 0.5F), (double)(var13 + 0.5F), 0.0D);
                var8.addVertex((double)((float)var9 + 0.5F), (double)(var13 + (float)var14 + 0.5F), 0.0D);
                var13 += (float)var14;
                long var16 = this.chunkTimes[var9] / 200000L;
                var8.setColorOpaque_I(-16777216 + var10 * 65536);
                var8.addVertex((double)((float)var9 + 0.5F), (double)(var13 + 0.5F), 0.0D);
                var8.addVertex((double)((float)var9 + 0.5F), (double)(var13 + (float)var16 + 0.5F), 0.0D);
                var13 += (float)var16;
                ...
                if (var18 > 0L)
                {
                    ...
                    var8.addVertex((double)((float)var9 + 0.5F), (double)(var13 + 0.5F), 0.0D);
                    var8.addVertex((double)((float)var9 + 0.5F), (double)(var13 + (float)var20 + 0.5F), 0.0D);
                }
            }
    ...
    private void updateFogColor(float par1)
    {
        ...
        double var18 = (var3.lastTickPosY + (var3.posY - var3.lastTickPosY) * (double)par1) * var16;

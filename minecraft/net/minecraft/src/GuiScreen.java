...
public class GuiScreen extends Gui
{
     ...
     */
    public void renderHold(int i, int cHeight /*Height for the box to be draw from the top.*/)
    {
        ...
        tessellator.addVertexWithUV(0.0D, cHeight, 0.0D, 0.0D, (float)cHeight / f + (float)i);
        tessellator.addVertexWithUV(width, cHeight, 0.0D, (float)width / f, (float)cHeight / f + (float)i);
        tessellator.addVertexWithUV(width, 0.0D, 0.0D, (float)width / f, 0 + i);
        tessellator.addVertexWithUV(0.0D, 0.0D, 0.0D, 0.0D, 0 + i);
        tessellator.draw();
        drawGradientRect(0, cHeight, width, cHeight + 2, 0xff000000, 0x01000000);
    }

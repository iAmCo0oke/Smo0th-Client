...
public class Tessellator
{
    ...
    private TextureStitched[] vertexIcons;
    ...
    public Tessellator(int par1)
    {
        ...
        this.vertexIcons = new TextureStitched[this.bufferSize];
    }
    ...
    private int drawForIcon(TextureStitched var1, int var2)
    {
        ...
        {
            TextureStitched var6 = this.vertexIcons[var5];
        ...
        else
        {
            ...
            if (this.vertexCount > 0)
            {
                if (this.renderingChunk && Config.isMultiTexture())
                {
                    ...
                    for (int var4 = 0; var4 < this.addedVertices; ++var4)
                    {
                        TextureStitched var5 = this.vertexIcons[var4];
                        int var6 = var5.getIndexInMap();

                        if (!this.drawnIcons[var6])
                        {
                            if (var5 == TextureUtils.iconGrassSideOverlay)
                            {
                                if (var3 < 0)
                                {
                                    var3 = var4;
                            ...
                            {
                                var4 = this.drawForIcon(var5, var4) - 1;
                                ++var2;
                                this.drawnIcons[var6] = true;
                            }
                        }
                    }
        ...
        if (this.renderingChunk && Config.isMultiTexture())
        {
            ...
            else
            {
                ...
                for (int var27 = 0; var27 < 4; ++var27)
                {
                    ...
                    par7 = var28.u;
                    par9 = var28.v;
                    this.vertexIcons[var22 + var27] = var17;
                    par7 -= var18;
                    par9 -= var20;
                    par7 *= (double)var23;
                    par9 *= (double)var24;
    ...
    public void addVertex(double par1, double par3, double par5)
    {
        if (this.autoGrow && this.rawBufferIndex >= this.bufferSize - 32)
        {
            ...
            this.floatBuffer = this.byteBuffer.asFloatBuffer();
            this.shortBuffer = this.byteBuffer.asShortBuffer();
            TextureStitched[] var8 = new TextureStitched[this.bufferSize];
            System.arraycopy(this.vertexIcons, 0, var8, 0, this.vertexIcons.length);
            this.vertexIcons = var8;
        }

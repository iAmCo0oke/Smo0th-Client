...
public class BlockPistonBase extends Block
{
    ...
    public Icon getIcon(int par1, int par2)
    {
        ...
        return var3 > 5 ? this.field_94497_cO : (par1 == var3 ? (!isExtended(par2) && this.minX <= 0.0D && this.minY <= 0.0D && this.minZ <= 0.0D && this.maxX >= 1.0D && this.maxY >= 1.0D && this.maxZ >= 1.0D ? this.field_94497_cO : this.field_94498_b) : (par1 == Facing.oppositeSide[var3] ? this.field_94499_c : this.blockIcon));
    }
